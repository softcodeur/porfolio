/* -------------------------------------------------------------------
 * Template Name         : Portical - Portfolio Template
...
/* 15.Pricing Tab Toggle
/* ------------------------------------------------------------------- */
function portical_pricingTabToggle(){
    "use-scrict";
...
function portical_contactForm(){
    ...
    $("#contactBtn").on("click",function(event) {
        ...
        if(name===''||email===''||message===''||subject===''){
            $('div.empty-form').slideDown(500).delay(2000).slideUp(500);
        }else if (!validateEmail===true) {
            $('div.email-invalid').slideDown(500).delay(2000).slideUp(500);
        }else {
